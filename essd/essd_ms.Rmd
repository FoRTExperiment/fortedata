...
ggplot(no_of_records, aes(x = as.factor(Month), y = as.integer(Year), fill= NoRecs)) +
  geom_tile(aes(fill = NoRecs), color = "black") +
  geom_text(aes(label = NoRecs), color = "white") +
  coord_equal()+
  scale_fill_gradient(low = "#0D69E0", high = "#052755", na.value = 'white')+
  scale_y_reverse()+
  theme_minimal()+
  theme(legend.position = "none")+
  ylab("Year")+
  xlab("Month")+
  ggtitle(paste("No. of observations currently availble in each function as of:", Sys.Date()))+
