...
```{r no_of_obs, fig.width = 8, fig.height = 10}
...
**Table S5.** Inventory dataset. `fd_plot_metadata` is an external function that returns plot and subplot level disturbance and treatment assignments. 
```{r disturbance}
make_table(md, "fd_plot_metadata")
