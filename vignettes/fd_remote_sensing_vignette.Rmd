...
During FoRTE, multiple types of remote sensing data are being collected with the goal of creating a record of forest structural and spectral change. These data are collected coincident with other data as outline below (see Remote Sensing Methods) 
...
```{r observations, fig.height = 4, fig.width = 6, fig.align = "center"}
