...
* `fd_canopy_structure()` returns a single dataset that includes 28 structural metrics estimating canopy structural traits such as height, area/density, openness, complexity, and arrangement. Data were processed using  `forestr` version 1.0.1 (Atkins et al. 2018) in R Version 3.6.2 (R Core Team, 2020).
