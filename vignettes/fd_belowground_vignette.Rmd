...
`fd_soil_respiration()` which returns a single dataset of 2780 observations each of soil CO2 efflux (μmol CO2 m-2 s-1) as well as soil micrometeorological measurements: soil temperature (°C; integrated from 0 to 7 cm depth), and volumetric water content (%) for the year 2019.
