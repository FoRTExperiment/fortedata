...
* `fd_dendro()` returns a single dataset of dendrometer band measurements (in) at ~1.3m stem height collected by hand from a subsample of trees >= 8cm DBH from all 32 subpots of the FoRTE experiment. 
...
* `fd_double_dendro()` returns a single dataset of dendrometer band measurements (in) at ~1.3m stem height and ~1.8m stem height on a subsample of trees >= 8cm DBH.
