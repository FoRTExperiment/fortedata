...
## ----lit_by_treatment, fig.width = 6, fig.asp = 1, fig.align="center", echo = FALSE, warning=FALSE, message=FALSE----
x <- fd_litter()
...
## ----lai, fig.height = 3.5, fig.width = 6, fig.align = "center", echo = FALSE, message = FALSE----
